...
{{ "This page is from _the future!_ It's the shiny new version of the [Embed Options & Plugins documentation](http://wistia.com/doc/embed-options). In a few weeks (during the week of October 12th), this page will replace the existing Embed Options & Plugins page. See you then! 👋" | note }}
