...
{{ "Just a heads up, Wistia media pages don't have the HubSpot tracking code on them. You'll need to embed your videos out in the wild in order to start pulling data into HubSpot." | alert }}
