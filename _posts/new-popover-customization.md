...
{{ "This page is from _the future!_ It's the shiny new version of the [Popover Customization documentation](http://wistia.com/doc/popover-customization). In a few weeks (during the week of October 12th), this page will replace the existing Popover Customization page. See you then! 👋" | note }}
