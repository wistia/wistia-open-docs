...
When your Wistia account is created, a master token will automatically be generated for you account, which you can find in the _API_ tab of your [_Account Settings_]({{ '/account-setup' | post_url }}). This master token has full read/write permissions on your account. You can generate additional access tokens with various permissions right there as well. Huzzah!
