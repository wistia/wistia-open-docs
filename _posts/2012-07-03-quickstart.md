...
\\
`<style float-right>`{{:share-project1.png?200}}`</style>`
\\
...
`<style float-right>`{{:share-dialog1.png?300}}`</style>`
\\
\\
...
**Note:** When you share a project with a contact, they will only have access to that project, and will only see the controls you have given them. They will, however, see any sidebar elements and comments inside of the project and media.
\\
\\
...
\\
`<style float-right>`{{:quickstart_private_user_sessions_dropdown.png|}}`</style>`
\\
\\
\\
\\
...
\\
\\
`<style float-right>`{{:quickstart_private_user_sessions.png|}}`</style>`
\\
\\
\\
...
\\
\\
`<style float-right>`{{:quickstart_private_user.png|}}`</style>`
\\
\\
